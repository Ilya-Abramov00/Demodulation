...
int main() {
    ...
    Reader reader;
    std::string ds = "/home/ann/WORK/work_mtlb/mtlb_demodulation/DATA_for_deAM";
    SignalFile< float > fileM = reader.readFile< float >( ds );
    std::cout << fileM.freqSample() << std::endl;
    ...
    Writer writer;
    std::string directory = "/home/ann/WORK/work_mtlb/mtlb_demodulation/";
